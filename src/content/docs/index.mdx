...
This [MDX](https://mdxjs.com/) source for this page lives in `src/content/docs/index.mdx`, but pages can also be authored as plain Markdown or [Markdoc](https://markdoc.dev).
